 ...
 * @property string $folder_path 网站链接
 ...
 * @property string $release 网站链接
 * @property string $t_body 其他介绍
 * @property string $table_co 数据表
 * @property string $table_lm 分类数据表
 * @property string $tfile 接口文件
 * @property string $title 标题
 * @property string $tlm 对应分类
 * @property string $web_url 网站链接
 ...
 * @property-read \app\common\model\WebLm $profile
 * @method static \think\db\Query onlyTrashed()
 * @method static \think\db\Query withTrashed()
 */
class WebCo extends Model{
	use SoftDelete;

	// 定义一对一关联  
	public function profile()  
	{
		return $this->hasOne(WebLm::class, 'id_lm', 'lm');  
	}

	public function record(){
		return $this->hasOne(FeedRecord::class,'web_id','id');
	}
