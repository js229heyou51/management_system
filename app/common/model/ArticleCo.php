...
/**
 * Class app\common\model\ArticleCo
 *
 ...
 * @property-read \app\common\model\ArticleLm $profile
 * @method static \think\db\Query onlyTrashed()
 * @method static \think\db\Query withTrashed()
 */
class ArticleCo extends Model{
	use SoftDelete;
	...
	{
		return $this->hasOne(ArticleLm::class, 'id_lm', 'lm');  
	}
