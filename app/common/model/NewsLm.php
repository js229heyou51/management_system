 ...
 * @property-read \app\common\model\NewsCo[] $info
 * @property-read \app\common\model\NewsCo[] $used_info
 * @method static \think\db\Query onlyTrashed()
 * @method static \think\db\Query withTrashed()
 */
class NewsLm extends Model{
	use SoftDelete;
	...
	public function info(){
		return $this->hasMany(NewsCo::class, 'lm');
		// 'lm_id'是NewsCo中指向NewsLm的外键字段
	}
	// 关联文章表（一对多）
