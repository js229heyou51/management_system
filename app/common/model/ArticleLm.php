...
/**
 * Class app\common\model\ArticleLm
 *
 ...
 * @property-read \app\common\model\ArticleCo[] $info
 * @property-read \app\common\model\ArticleCo[] $used_info
 * @method static \think\db\Query onlyTrashed()
 * @method static \think\db\Query withTrashed()
 */
class ArticleLm extends Model{
	use SoftDelete;
	...
	public function info(){
		return $this->hasMany(ArticleCo::class, 'lm');
		// 'lm_id'是ArticleCo中指向ArticleLm的外键字段
	}
	// 关联文章表（一对多）
