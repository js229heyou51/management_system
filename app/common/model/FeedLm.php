 ...
 * @property-read \app\common\model\FeedCo[] $info
 * @property-read \app\common\model\FeedCo[] $used_info
 * @method static \think\db\Query onlyTrashed()
 * @method static \think\db\Query withTrashed()
 */
class FeedLm extends Model{
	use SoftDelete;
	...
	public function info(){
		return $this->hasMany(FeedCo::class, 'lm');
