 ...
 * @property string $param_json 页面名称
 ...
 * @property-read \app\common\model\ProCo[] $profile
 * @property-read \app\common\model\ProLm[] $children
...
class ProLm extends Model{
	...
	public function children(){
		return $this->hasMany(ProLm::class, 'fid', 'id_lm');  
	}

	public function profile(){
		return $this->hasMany(ProCo::class, 'lm', 'id_lm');  
	}
